...
public class SkyWarsAreaSaveSubCommand extends BaseSubCommand {
    public SkyWarsAreaSaveSubCommand() {
        super("save", "保存空岛战争场地", "/cc game area skywars save <场地名>");
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        if (args.length == 1) {
            if (plugin.getGameManager().getSkyWarsManager().saveArea(args[0])) {
