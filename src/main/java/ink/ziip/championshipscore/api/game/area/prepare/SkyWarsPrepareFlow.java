...
public final class SkyWarsPrepareFlow extends SnapshotMapPrepareFlow {
    ...
    @Override public @NotNull List<PrepareStep> buildSteps(@NotNull SetupTarget target) {
        ...
        steps.add(new StandAndRunStep("pre_spawn", Component.text("正式准备点"),
                Component.text("站到开局准备位置后点击"), Material.CLOCK,
                t -> cfg(t).getPreSpawnPoint() != null, (t, l) -> cfg(t).setPreSpawnPoint(l),
                Utils.formatAdminSuccess("已设置正式准备点。")));
