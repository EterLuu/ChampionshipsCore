...
public class ScheduleManager extends BaseManager {
    ...
    private volatile ScheduledTask dodgeboltTransitionTask;
    private volatile ScheduledTask dragonEggCarnivalTransitionTask;
    ...
    public synchronized EventAction startOrStopFormalEvent(@NotNull GameTypeEnum gameTypeEnum) {
    ...
    public synchronized EventAction startOrStopDragonEggCarnival(@NotNull ChampionshipTeam team,
    ...
    public synchronized boolean stopFormalEvent(@NotNull GameTypeEnum gameTypeEnum) {
     ...
     */
    public synchronized void endGameSchedule(GameTypeEnum gameTypeEnum) {
        switch (gameTypeEnum) {
    ...
    private synchronized void startDragonEggCarnival(ChampionshipTeam team, ChampionshipTeam rival) {
    ...
    public synchronized void requestDodgeboltFinal(String requestedArea, ChampionshipTeam requestedRight,
    ...
    private synchronized void startDodgeboltTransition(String area, DodgeboltArea instance,
