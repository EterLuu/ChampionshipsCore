...
public interface RankDao {
    ...
    List<TeamPointEntry> getTeamPoints(int teamId);

    List<PlayerPointEntry> getPlayerPoints(UUID uuid);

    List<PlayerPointEntry> getTeamPlayerPoints(int teamId);

    int addTeamPoint(TeamPointEntry teamPointEntry);

    int addPlayerPoint(PlayerPointEntry playerPointEntry);

    List<GameStatusEntry> getGameStatusList();

    int getGameStatusOrder(GameTypeEnum gameTypeEnum);

    int addGameStatus(GameStatusEntry gameStatusEntry);
